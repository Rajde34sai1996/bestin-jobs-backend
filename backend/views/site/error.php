...
<div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left" style="    background: #399cff;
    ...
    <div class="text-white mt-10 lg:mt-0">
        ...
        </div> <!-- Oops. This page has gone missing. -->
        <div class="intro-x text-lg mt-3">You may have mistyped the address or the page may have moved.</div>
        <a href="<?= Yii::$app->request->baseUrl; ?>"><button
                class="intro-x button button--lg border border-white mt-10" style="
    color: #03a5ff;">Back to Home</button></a>
    </div>
</div>